...
DOCKER_VERSION_NUMBER="ucyo/wetter:${DOCKER_TAG}"
DOCKER_FILE="${SOURCE_DIR}/../"
DOCKER_VERSION_RELATIVE="ucyo/wetter:testing"

if [[ $DOCKER_BRANCH != *"dev"* ]]; then
  DOCKER_VERSION_RELATIVE="ucyo/wetter:latest"
fi
