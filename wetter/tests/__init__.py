"""Testing module for the wetter package.

This folder contains the testing data for the wetter package.
For testing pruposes the library is using `pytest`.
The structure is the same as the package folder itself.
